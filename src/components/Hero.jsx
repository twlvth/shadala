...
const Hero = () => {
  ...
  <div className="font-Montserrat bg-gradient-to-b from-white via-white to-teal-200 pb-2">
      <div className="max-w-[800px] my-[-96px] w-full h-[60vh] mx-auto text-center flex flex-col justify-center">
        ...
        <div className="flex justify-center items-center">
          <p className="md:text-5xl sm:text-4xl text-xl font-bold text-[#10969fa9]">Siya! Dala!</p>
          <ReactTyped
        ...
        <div className="flex space-x-4 mt-6 justify-center p-3"> 
          <button
            type="button"
            className="flex items-center text-white bg-[#10969f] hover:bg-[#20848b] font-medium rounded-[20px] px-5 py-3"><span className="flex items-center font-bold">
  ...
  >
    <span className="flex items-center font-bold">
      <FaBox className='mr-1' />Track Parcel
    </span>
  </button>
</div>
